...
namespace Maersk_Line.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingID,WarehouseID,ShipYardID,ShipID,ContainerID,Price,Date,Time,Departure,Destination")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingID,WarehouseID,ShipYardID,ShipID,ContainerID,Price,Date,Time,Departure,Destination")] Booking booking)
        {
            if (ModelState.IsValid)
            {
