...
namespace Maersk_Line.Controllers
{
    ...
    public class ShipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipID,ShipName,ShipDescription,NumberOfContainersCarried")] Ships ships)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShipID,ShipName,ShipDescription,NumberOfContainersCarried")] Ships ships)
        {
            if (ModelState.IsValid)
            {
